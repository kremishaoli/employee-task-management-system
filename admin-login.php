...
<header>
  ...
  <nav>
    <ul>
      ...
      <li><a href="admin-login.php" class="active">Admin Login</a></li>
...
<section class="login-section">
  ...
  <form action="login-process.php" method="POST" id="loginFormAdmin" novalidate>
